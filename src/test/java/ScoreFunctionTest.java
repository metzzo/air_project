...
class ScoreFunctionTest {
    ...
    void setUp() {
        ...
        this.doc1.setAverageTermFrequency((4 + 2 + 1)/3.0);

        this.doc2 = repo.register("doc2", 10);
        this.doc2.setAverageTermFrequency((8 + 1 + 1)/3.0);

        this.doc3 = repo.register("doc3", 7);
        this.doc3.setAverageTermFrequency((4 + 2 + 1)/3.0);
        ...
        this.doc1.setMaxFrequencyOfTerm(4);
        this.doc2.setMaxFrequencyOfTerm(8);
        this.doc3.setMaxFrequencyOfTerm(4);
    ...
    void scoreWithBM25() {
        // arrange
        ScoreFunction scorer = new BM25Score(1.5, 0.75);
    ...
    void scoreWithBM25VA() {
        // arrange
        ScoreFunction scorer = new BM25VAScore(1.5);
    ...
    void scoreWithTFIDF() {
        // arrange
        ScoreFunction scorer = new TFIDFScore();
